...
/*
A. Inside the “Functions” folder create a Folder called “SpreadDestructFuncExercise”
B. Inside the “SpreadDestructFuncExercise” folder create an script.js file
*/
...
// B-3b. Create a function called seeJPMovies. Having only the following inside the opening and closing curly brackets of the seeJPMovies function (See below), have all six movie names display in the terminal/console when the function is run (HINT: There are at least two ways this can be done)...
/*
 console.log(one);
 console.log(two);
 console.log(three);
...
// https://forms.gle/F4BhWeeTEk3zW2Aw8
